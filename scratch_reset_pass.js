...
async function resetPasswords() {
    const defaultPassword = obfuscate('docente2026');
    ...
    for (const user of users) {
        if (user.password !== defaultPassword) {
            console.log(`Reseteando contraseña para: ${user.email}`);
    ...
    console.log(`\n¡Proceso terminado! Se restablecieron las contraseñas de ${resetCount} usuarios a 'docente2026'.`);
}
